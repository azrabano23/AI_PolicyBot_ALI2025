...
const Ali2025AdvancedBot = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const apiUrl = process.env.REACT_APP_API_URL || (process.env.NODE_ENV === 'production' ? 'https://web-production-faf17.up.railway.app/api/chat' : 'http://localhost:8081/api/chat');
